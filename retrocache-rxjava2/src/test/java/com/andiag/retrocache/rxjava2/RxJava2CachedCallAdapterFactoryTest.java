...
public class RxJava2CachedCallAdapterFactoryTest {
    private static final Annotation[] NO_ANNOTATIONS = new Annotation[0];

    private final CallAdapter.Factory factory = RxJava2CachedCallAdapterFactory.create(new MockCachingSystem());
    ...
    public void nullSchedulerThrows() {
        try {
            RxJava2CachedCallAdapterFactory.createWithScheduler(new MockCachingSystem(), null);
            fail();
